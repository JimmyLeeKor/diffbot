...
class sick_nav350: public rclcpp::Node
{
    public:
        ...
        { 
            ...
            //landmark_broadcasters =
            //      std::vector<tf2_ros::TransformBroadcaster>(*this);
        }
       ...
       /* Instantiate the object */
        ...
        try
        {
          ...
          else
          {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
              ...
              geometry_msgs::msg::TransformStamped test_buffer1 =
                  tf_buffer->lookupTransform(sick_frame_id,target_frame_id,current_time,rclcpp::Duration(TRANSFORM_TIMEOUT));
          ...
          while (rclcpp::ok() && !need_exit)
          {
            ...
            sick_nav350.GetSickMeasurements(range_values, intensity_values, &num_measurements, &sector_step_angle, &sector_start_angle, &sector_stop_angle, &sector_start_timestamp, &sector_stop_timestamp);
            ...
            */
            ...
            if(publish_odom)
            {
                ...
                createOdometryMessage(rclcpp::Clock().now() - previous_time, mobile_base_prev_tf, mobile_base_current_tf);
